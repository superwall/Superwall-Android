...
fun mockProductDetails(
    ...
    subscriptionOfferDetails: List<ProductDetails.SubscriptionOfferDetails>? = listOf(
...
): ProductDetails.SubscriptionOfferDetails = mockk<ProductDetails.SubscriptionOfferDetails>().apply {
