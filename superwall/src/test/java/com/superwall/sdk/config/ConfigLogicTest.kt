...
internal class ConfigLogicTest {
    ...
    fun test_chooseVariant_99PercentSumVariants_chooseLast() {
        try {
            ...
            val variant = ConfigLogic.chooseVariant(
                options,
                randomiser = { range ->
    ...
    fun test_getRulesPerTriggerGroup_threeTriggersTwoWithSameGroupId() {
        val trigger1 = Trigger.stub().apply {
            rules = listOf(TriggerRule.stub().apply {
                experimentGroupId = "1"
            })
        }
        val trigger2 = Trigger.stub().apply {
            rules = listOf(TriggerRule.stub().apply {
                experimentGroupId = "1"
            })
        }
        val trigger3 = Trigger.stub().apply {
            rules = listOf(TriggerRule.stub().apply {
                experimentGroupId = "2"
            })
        }
    ...
    fun test_assignVariants_noTriggers() {
        ...
        // When
        val variant = ConfigLogic.chooseAssignments(
    ...
    fun test_chooseAssignments_variantAsOfYetUnconfirmed() {
        ...
        val variantOption = VariantOption.stub().apply {
            id = variantId
            paywallId = paywallId
            type = Experiment.Variant.VariantType.TREATMENT
        }
    ...
    fun test_processAssignmentsFromServer_overwriteConfirmedAssignment() {
        ...
        val variantOption = VariantOption.stub()
            .apply { id = variantId }
        val triggers = setOf(
            Trigger.stub()
                .apply { rules = listOf(
    ...
    fun test_processAssignmentsFromServer_multipleAssignments() {
        ...
        val unusedVariantOption1 = VariantOption.stub().apply {
            this.id = "unusedOption1"
        }
        val variantOption1 = VariantOption.stub()
            .apply { id = variantId1 }
        val variantOption2 = VariantOption.stub()
            .apply { id = variantId2 }
        val unusedVariantOption2 = VariantOption.stub()
    ...
    fun test_getStaticPaywall_noPaywallId() {
        val response = ConfigLogic.getStaticPaywall(
            withId = null,
            config = Config.stub(),
            deviceLocale = "en_GB"
        )
    ...
    fun test_filterTriggers_noTriggers() {
        val disabled = PreloadingDisabled(
            all = true,
    ...
    fun test_filterTriggers_disableAll() {
        ...
        val filteredTriggers = ConfigLogic.filterTriggers(
            triggers,
            disabled
        )
