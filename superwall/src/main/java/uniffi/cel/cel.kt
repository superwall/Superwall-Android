...
@file:Suppress("ktlint:standard:function-naming", "NAME_SHADOWING")
...
internal interface UniffiLib : Library {
    ...
    fun uniffi_celandroid_fn_func_with_context(
    ...
    fun uniffi_celandroid_checksum_func_with_context(): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_celandroid_checksum_func_with_context() != 16693.toShort()) {
...
fun `withContext`(`definition`: kotlin.String): kotlin.String =
    FfiConverterString.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_celandroid_fn_func_with_context(
