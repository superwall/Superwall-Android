...
@Serializable
data class Postback(val products: List<PostbackProduct>)

@Serializable
data class PostbackProduct(
    val identifier: String,
    // TODO: Figure out productVariables type
    val productVariables: Map<String, @Serializable(with = AnySerializer::class) Any>, // Assuming JSON as Map<String, Any>
...
@Serializable
data class SWProduct(val id: String)
