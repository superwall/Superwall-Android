...
class PaywallView(
    ...
    fun beforeOnDestroy(isActivityFinishing: Boolean = false) {
        if (state.isBrowserViewPresented && !isActivityFinishing) {
            return
        }
    ...
    suspend fun destroyed(isActivityFinishing: Boolean = false) {
        if (state.isBrowserViewPresented && !isActivityFinishing) {
            return
        }
