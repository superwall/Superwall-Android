...
sealed class PaywallWebEvent {
    ...
    @SerialName("opened_url") data class OpenedURL(val url: URL) : PaywallWebEvent()
    @SerialName("opened_url_in_safari") data class OpenedUrlInSafari(val url: URL) : PaywallWebEvent()
    @SerialName("opened_deep_link") data class OpenedDeepLink(val url: URL) : PaywallWebEvent()
}