...
class PaywallViewControllerCache(
    private val deviceLocaleString: String,
) {
    ...
    fun getPaywallViewController(key: String): PaywallViewController? = runBlocking(singleThreadContext) { cache[key] }
